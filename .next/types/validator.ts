...
// Validate ../../src/app/api/invoices/draft/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/invoices/draft">> = Specific
  const handler = {} as typeof import("../../src/app/api/invoices/draft/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
